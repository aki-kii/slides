...
<div style="view-transition-name: recommended-customize">
  ...
  <div class="flex items-baseline gap-4">
    <h2 class="!m-0">ESLint</h2>
    <span>コードを解析してルールに従って検査するツール</span>
  </div>
</div>
...
<div style="view-transition-name: recommended-customize">
  おすすめカスタマイズ
  <div class="flex items-baseline gap-4">
    <h2 class="!m-0">Oxfmt</h2>
    <span>コードを解析してルールに従って成形するツール</span>
  </div>
</div>
...
<div style="view-transition-name: recommended-customize">
  おすすめカスタマイズ
  <div class="flex items-baseline gap-4">
    <h2 class="!m-0">Snapshot Test</h2>
    <span>CDKから生成するテンプレートの差分を検証する</span>
  </div>
</div>
