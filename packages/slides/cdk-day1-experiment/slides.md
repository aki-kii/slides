...
<PlainList>
  <li>初期構築に手間取るのならCDKを使いたくない…となる</li>
...
## ③ CDKの便利機能 （or L2 Construct） を活用するべし

- L2 Constructはリソースを使いやすい単位で設定できる
  - VPCを例示
- Grantsはマネコンの方が簡単と思っている方にも衝撃的？
- fromLookUpメソッドでデプロイされてるリソースも取り込める
